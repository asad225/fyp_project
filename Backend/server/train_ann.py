...
documents = []
ignore_words = ["?", "!"]
data_file = open("mental_health_intents.json").read()
...
pickle.dump(words, open("mental_health_words.pkl", "wb"))
pickle.dump(classes, open("mental_health_classes.pkl", "wb"))
...
model.save("mental_health_ann.h5", hist)
print("model created")
